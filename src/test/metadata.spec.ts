...
export class BaseTestEntityController extends ODataController {
    ...
    @Edm.Action
    baseTestEntityAction( @Edm.EnumType(Genre) value: Genre) {
        console.log(value);
    }

    @Edm.Function(Edm.EnumType(Genre))
    baseTestEntityFunction( @Edm.EnumType(Genre) value: Genre) {
        return value;
    }
