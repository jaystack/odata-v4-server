...
export class MetaController extends ODataController {
    ...
    // @odata.DELETE("MediaList").$ref
    // unsetMedia( @odata.key key: string, @odata.link link: string) {}
